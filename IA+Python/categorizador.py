...
def categoriza_produto(nome_produto, lista_categorias_possiveis):
    ...
    resposta = cliente.chat.completions.create(
        ...
        model=modelo, 
        temperature = 0, #adicionando uma temperatura - definindo o nível de criatividade
        max_tokens = 200,
        #n = 3, #define a quantidade de respostas da IA
    ) 
    return resposta.choices[0].messages.content
