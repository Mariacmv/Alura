...
AWS_ACCESS_KEY_ID = str(os.getenv('AWS_ACCESS_KEY_ID')) #colocar o que falta no arquivo .env
AWS_SECRET_ACCESS_KEY = str(os.getenv('AWS_SECRET_ACCESS_KEY')) #colocar o que falta no arquivo .env
AWS_STORAGE_BUCKET_NAME = str(os.getenv('AWS_STORAGE_BUCKET_NAME')) #colocar o que falta no arquivo .env
